 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class u extends Error{constructor(e){super("[GoogleGenerativeAI Error]: ".concat(e))}}class I extends u{constructor(e,n){super(e),this.response=n}}class q extends u{constructor(e,n,s,o){super(e),this.status=n,this.statusText=s,this.errorDetails=o}}class E extends u{}class P extends u{}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X="https://generativelanguage.googleapis.com",Q="v1beta",z="0.24.1",Z="genai-js";var C;(function(t){t.GENERATE_CONTENT="generateContent",t.STREAM_GENERATE_CONTENT="streamGenerateContent",t.COUNT_TOKENS="countTokens",t.EMBED_CONTENT="embedContent",t.BATCH_EMBED_CONTENTS="batchEmbedContents"})(C||(C={}));class tt{constructor(e,n,s,o,i){this.model=e,this.task=n,this.apiKey=s,this.stream=o,this.requestOptions=i}toString(){var e,n;const s=((e=this.requestOptions)===null||e===void 0?void 0:e.apiVersion)||Q,o=((n=this.requestOptions)===null||n===void 0?void 0:n.baseUrl)||X;let i="".concat(o,"/").concat(s,"/").concat(this.model,":").concat(this.task);return this.stream&&(i+="?alt=sse"),i}}function et(t){const e=[];return t!=null&&t.apiClient&&e.push(t.apiClient),e.push("".concat(Z,"/").concat(z)),e.join(" ")}async function nt(t){var e;const n=new Headers;n.append("Content-Type","application/json"),n.append("x-goog-api-client",et(t.requestOptions)),n.append("x-goog-api-key",t.apiKey);let s=(e=t.requestOptions)===null||e===void 0?void 0:e.customHeaders;if(s){if(!(s instanceof Headers))try{s=new Headers(s)}catch(o){throw new E("unable to convert customHeaders value ".concat(JSON.stringify(s)," to Headers: ").concat(o.message))}for(const[o,i]of s.entries()){if(o==="x-goog-api-key")throw new E("Cannot set reserved header name ".concat(o));if(o==="x-goog-api-client")throw new E("Header name ".concat(o," can only be set using the apiClient field"));n.append(o,i)}}return n}async function st(t,e,n,s,o,i){const a=new tt(t,e,n,s,i);return{url:a.toString(),fetchOptions:Object.assign(Object.assign({},rt(i)),{method:"POST",headers:await nt(a),body:o})}}async function y(t,e,n,s,o,i={},a=fetch){const{url:r,fetchOptions:d}=await st(t,e,n,s,o,i);return ot(r,d,a)}async function ot(t,e,n=fetch){let s;try{s=await n(t,e)}catch(o){it(o,t)}return s.ok||await at(s,t),s}function it(t,e){let n=t;throw n.name==="AbortError"?(n=new P("Request aborted when fetching ".concat(e.toString(),": ").concat(t.message)),n.stack=t.stack):t instanceof q||t instanceof E||(n=new u("Error fetching from ".concat(e.toString(),": ").concat(t.message)),n.stack=t.stack),n}async function at(t,e){let n="",s;try{const o=await t.json();n=o.error.message,o.error.details&&(n+=" ".concat(JSON.stringify(o.error.details)),s=o.error.details)}catch(o){}throw new q("Error fetching from ".concat(e.toString(),": [").concat(t.status," ").concat(t.statusText,"] ").concat(n),t.status,t.statusText,s)}function rt(t){const e={};if((t==null?void 0:t.signal)!==void 0||(t==null?void 0:t.timeout)>=0){const n=new AbortController;(t==null?void 0:t.timeout)>=0&&setTimeout(()=>n.abort(),t.timeout),t!=null&&t.signal&&t.signal.addEventListener("abort",()=>{n.abort()}),e.signal=n.signal}return e}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N(t){return t.text=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn("This response had ".concat(t.candidates.length," ")+"candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates."),S(t.candidates[0]))throw new I("".concat(g(t)),t);return ct(t)}else if(t.promptFeedback)throw new I("Text not available. ".concat(g(t)),t);return""},t.functionCall=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn("This response had ".concat(t.candidates.length," ")+"candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates."),S(t.candidates[0]))throw new I("".concat(g(t)),t);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),F(t)[0]}else if(t.promptFeedback)throw new I("Function call not available. ".concat(g(t)),t)},t.functionCalls=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn("This response had ".concat(t.candidates.length," ")+"candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates."),S(t.candidates[0]))throw new I("".concat(g(t)),t);return F(t)}else if(t.promptFeedback)throw new I("Function call not available. ".concat(g(t)),t)},t}function ct(t){var e,n,s,o;const i=[];if(!((n=(e=t.candidates)===null||e===void 0?void 0:e[0].content)===null||n===void 0)&&n.parts)for(const a of(o=(s=t.candidates)===null||s===void 0?void 0:s[0].content)===null||o===void 0?void 0:o.parts)a.text&&i.push(a.text),a.executableCode&&i.push("\n```"+a.executableCode.language+"\n"+a.executableCode.code+"\n```\n"),a.codeExecutionResult&&i.push("\n```\n"+a.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}function F(t){var e,n,s,o;const i=[];if(!((n=(e=t.candidates)===null||e===void 0?void 0:e[0].content)===null||n===void 0)&&n.parts)for(const a of(o=(s=t.candidates)===null||s===void 0?void 0:s[0].content)===null||o===void 0?void 0:o.parts)a.functionCall&&i.push(a.functionCall);if(i.length>0)return i}const dt=[R.RECITATION,R.SAFETY,R.LANGUAGE];function S(t){return!!t.finishReason&&dt.includes(t.finishReason)}function g(t){var e,n,s;let o="";if((!t.candidates||t.candidates.length===0)&&t.promptFeedback)o+="Response was blocked",!((e=t.promptFeedback)===null||e===void 0)&&e.blockReason&&(o+=" due to ".concat(t.promptFeedback.blockReason)),!((n=t.promptFeedback)===null||n===void 0)&&n.blockReasonMessage&&(o+=": ".concat(t.promptFeedback.blockReasonMessage));else if(!((s=t.candidates)===null||s===void 0)&&s[0]){const i=t.candidates[0];S(i)&&(o+="Candidate was blocked due to ".concat(i.finishReason),i.finishMessage&&(o+=": ".concat(i.finishMessage)))}return o}function p(t){return this instanceof p?(this.v=t,this):new p(t)}function lt(t,e,n){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var s=n.apply(t,e||[]),o,i=[];return o={},a("next"),a("throw"),a("return"),o[Symbol.asyncIterator]=function(){return this},o;function a(l){s[l]&&(o[l]=function(c){return new Promise(function(f,O){i.push([l,c,f,O])>1||r(l,c)})})}function r(l,c){try{d(s[l](c))}catch(f){v(i[0][3],f)}}function d(l){l.value instanceof p?Promise.resolve(l.value.v).then(h,_):v(i[0][2],l)}function h(l){r("next",l)}function _(l){r("throw",l)}function v(l,c){l(c),i.shift(),i.length&&r(i[0][0],i[0][1])}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],Ot={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function It(t){let e=!1;for(const n of t){const{role:s,parts:o}=n;if(!e&&s!=="user")throw new u("First content should be with role 'user', got ".concat(s));if(!b.includes(s))throw new u("Each item should include role field. Got ".concat(s," but valid roles are: ").concat(JSON.stringify(b)));if(!Array.isArray(o))throw new u("Content should have 'parts' property with an array of Parts");if(o.length===0)throw new u("Each Content should have at least one part");const i={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(const r of o)for(const d of K)d in r&&(i[d]+=1);const a=Ot[s];for(const r of K)if(!a.includes(r)&&i[r]>0)throw new u("Content with role '".concat(s,"' can't contain '").concat(r,"' part"));e=!0}}function Y(t){var e;if(t.candidates===void 0||t.candidates.length===0)return!1;const n=(e=t.candidates[0])===null||e===void 0?void 0:e.content;if(n===void 0||n.parts===void 0||n.parts.length===0)return!1;for(const s of n.parts)if(s===void 0||Object.keys(s).length===0||s.text!==void 0&&s.text==="")return!1;return!0}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
