...
(function () {
  ...
  System.register(['./index-legacy-eBtV7UbJ.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [function (module) {
        ...
        useImage = module.L;
        omit = module.N;
        shouldShowFallbackImage = module.O;
        useEnvironment = module.P;
        useTheme = module.Q;
        isObject = module.U;
        breakpoints = module.W;
        arrayToObjectNotation = module.X;
        useStyleConfig = module.Y;
...
//# sourceMappingURL=NewsSection-legacy-jLmSzm6X.js.map
