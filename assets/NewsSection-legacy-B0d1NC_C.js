  ...
  System.register(['./index-legacy-CD1LHlIS.js'], function (exports, module) {
    ...
    return {
      setters: [function (module) {
        ...
        useImage = module.J;
        omit = module.K;
        shouldShowFallbackImage = module.L;
        useEnvironment = module.N;
        useTheme = module.O;
        isObject = module.Q;
        breakpoints = module.U;
        arrayToObjectNotation = module.W;
        useStyleConfig = module.X;
...
//# sourceMappingURL=NewsSection-legacy-B0d1NC_C.js.map
