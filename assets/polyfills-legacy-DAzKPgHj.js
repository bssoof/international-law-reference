(function () {
	...
	var toString$t = uncurryThis$17({}.toString);
	var stringSlice$e = uncurryThis$17(''.slice);

	var classofRaw$2 = function (it) {
	  return stringSlice$e(toString$t(it), 8, -1);
	};
	...
	var $Object$5 = Object;
	var split$3 = uncurryThis$16(''.split);
	...
	var requireObjectCoercible$f = function (it) {
	  if (isNullOrUndefined$6(it)) throw new $TypeError$v("Can't call method on " + it);
	  return it;
	};
	...
	var objectIsPrototypeOf = uncurryThis$15({}.isPrototypeOf);
	...
	var aCallable$o = function (argument) {
	  ...
	  throw new $TypeError$u(tryToString$6(argument) + ' is not a function');
	};
	...
	var ordinaryToPrimitive$2 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$r(fn = input.toString) && !isObject$C(val = call$G(fn, input))) return val;
	  if (isCallable$r(fn = input.valueOf) && !isObject$C(val = call$G(fn, input))) return val;
	  if (pref !== 'string' && isCallable$r(fn = input.toString) && !isObject$C(val = call$G(fn, input))) return val;
	...
	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$d(globalThis$10, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	...
	var hasOwnProperty = uncurryThis$14({}.hasOwnProperty);
	...
	var toString$s = uncurryThis$13(1.1.toString);
	...
	var Symbol$1 = globalThis$_.Symbol;
	...
	var wellKnownSymbol$y = function (name) {
	  if (!hasOwn$y(WellKnownSymbolsStore$1, name)) {
	    WellKnownSymbolsStore$1[name] = NATIVE_SYMBOL$6 && hasOwn$y(Symbol$1, name)
	      ? Symbol$1[name]
	...
	var ie8DomDefine = !DESCRIPTORS$E && !fails$16(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$D ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$x(O, P)) return createPropertyDescriptor$a(!call$E(propertyIsEnumerableModule$2.f, O, P), O[P]);
	};
	...
	var v8PrototypeDefineBug = DESCRIPTORS$C && fails$15(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var createNonEnumerableProperty$f = DESCRIPTORS$A ? function (object, key, value) {
	...
	var EXISTS = hasOwn$w(FunctionPrototype$1, 'name');
	// additional protection from minified / mangled / dropped function names
	var PROPER = EXISTS && (function something() { /* empty */ }).name === 'something';
	var CONFIGURABLE = EXISTS && (!DESCRIPTORS$z || (DESCRIPTORS$z && getDescriptor(FunctionPrototype$1, 'name').configurable));
	...
	var functionToString = uncurryThis$12(Function.toString);
	...
	var TypeError$9 = globalThis$X.TypeError;
	...
	if (NATIVE_WEAK_MAP$1 || shared$4.state) {
	  ...
	  set$2 = function (it, metadata) {
	    if (hasOwn$v(it, STATE)) throw new TypeError$9(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
	...
	var stringSlice$d = uncurryThis$11(''.slice);
	var replace$a = uncurryThis$11(''.replace);
	var join$7 = uncurryThis$11([].join);

	var CONFIGURABLE_LENGTH = DESCRIPTORS$y && !fails$14(function () {
	...
	var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
	  ...
	  if (!hasOwn$u(value, 'name') || (CONFIGURABLE_FUNCTION_NAME$2 && value.name !== name)) {
	    if (DESCRIPTORS$y) defineProperty$c(value, 'name', { value: name, configurable: true });
	    else value.name = name;
	  }
	  if (CONFIGURABLE_LENGTH && options && hasOwn$u(options, 'arity') && value.length !== options.arity) {
	    defineProperty$c(value, 'length', { value: options.arity });
	  }
	  try {
	    if (options && hasOwn$u(options, 'constructor') && options.constructor) {
	      if (DESCRIPTORS$y) defineProperty$c(value, 'prototype', { writable: false });
	    // in V8 ~ Chrome 53, prototypes of some methods, like `Array.prototype.values`, are non-writable
	    } else if (value.prototype) value.prototype = undefined;
	  } catch (error) { /* empty */ }
	  var state = enforceInternalState$4(value);
	  if (!hasOwn$u(state, 'source')) {
	...
	var toAbsoluteIndex$7 = function (index, length) {
	  ...
	  return integer < 0 ? max$4(integer + length, 0) : min$a(integer, length);
	};
	...
	var push$g = uncurryThis$10([].push);
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$t(hiddenKeys$4, key) && hasOwn$t(O, key) && push$g(result, key);
	  // Don't enum bug & hidden keys
	  while (names.length > i) if (hasOwn$t(O, key = names[i++])) {
	    ~indexOf$1(result, key) || push$g(result, key);
	  }
	  return result;
	};
	...
	var copyConstructorProperties$6 = function (target, source, exceptions) {
	  ...
	  for (var i = 0; i < keys.length; i++) {
	    var key = keys[i];
	    if (!hasOwn$s(target, key) && !(exceptions && hasOwn$s(exceptions, key))) {
	...
	var isForced$5 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$m(detection) ? fails$13(detection)
	    : !!detection;
	};
	...
	*/
	...
	var arraySlice$a = uncurryThis$_([].slice);
	...
	var wellKnownSymbolDefine = function (NAME) {
	  ...
	  if (!hasOwn$r(Symbol, NAME)) defineProperty$a(Symbol, NAME, {
	...
	var setToStringTag$e = function (target, TAG, STATIC) {
	  ...
	  if (target && !hasOwn$q(target, TO_STRING_TAG$4)) {
	...
	var bind$e = uncurryThis$Y(uncurryThis$Y.bind);
	...
	var exec$9 = uncurryThis$X(constructorRegExp.exec);
	...
	var arraySpeciesConstructor$1 = function (originalArray) {
	  ...
	  if (isArray$8(originalArray)) {
	    ...
	    if (isConstructor$3(C) && (C === $Array$4 || isArray$8(C.prototype))) C = undefined;
	...
	var setSymbolDescriptor = DESCRIPTORS$w && fails$11(function () {
	...
	var $defineProperty = function defineProperty(O, P, Attributes) {
	  ...
	  if (hasOwn$p(AllSymbols, key)) {
	    if (!Attributes.enumerable) {
	      if (!hasOwn$p(O, HIDDEN)) nativeDefineProperty$1(O, HIDDEN, createPropertyDescriptor$8(1, nativeObjectCreate(null)));
	      O[HIDDEN][key] = true;
	    } else {
	      if (hasOwn$p(O, HIDDEN) && O[HIDDEN][key]) O[HIDDEN][key] = false;
	...
	var $defineProperties = function defineProperties(O, Properties) {
	  ...
	  $forEach$2(keys, function (key) {
	    if (!DESCRIPTORS$w || call$C($propertyIsEnumerable$1, properties, key)) $defineProperty(O, key, properties[key]);
	  });
	  return O;
	};
	...
	var $propertyIsEnumerable$1 = function propertyIsEnumerable(V) {
	  ...
	  if (this === ObjectPrototype$4 && hasOwn$p(AllSymbols, P) && !hasOwn$p(ObjectPrototypeSymbols, P)) return false;
	  return enumerable || !hasOwn$p(this, P) || !hasOwn$p(AllSymbols, P) || hasOwn$p(this, HIDDEN) && this[HIDDEN][P]
	    ? enumerable : true;
	};
	...
	var $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(O, P) {
	  ...
	  var key = toPropertyKey$2(P);
	  if (it === ObjectPrototype$4 && hasOwn$p(AllSymbols, key) && !hasOwn$p(ObjectPrototypeSymbols, key)) return;
	  var descriptor = nativeGetOwnPropertyDescriptor$2(it, key);
	  if (descriptor && hasOwn$p(AllSymbols, key) && !(hasOwn$p(it, HIDDEN) && it[HIDDEN][key])) {
	...
	var $getOwnPropertyNames = function getOwnPropertyNames(O) {
	  ...
	  $forEach$2(names, function (key) {
	    if (!hasOwn$p(AllSymbols, key) && !hasOwn$p(hiddenKeys$1, key)) push$e(result, key);
	  });
	  return result;
	};
	...
	var $getOwnPropertySymbols = function (O) {
	  ...
	  var result = [];
	  $forEach$2(names, function (key) {
	    if (hasOwn$p(AllSymbols, key) && (!IS_OBJECT_PROTOTYPE || hasOwn$p(ObjectPrototype$4, key))) {
	...
	if (!NATIVE_SYMBOL$5) {
	  $Symbol = function Symbol() {
	    if (isPrototypeOf$a(SymbolPrototype$1, this)) throw new TypeError$8('Symbol is not a constructor');
	    var description = !arguments.length || arguments[0] === undefined ? undefined : $toString$3(arguments[0]);
	    var tag = uid$3(description);
	    var setter = function (value) {
	      var $this = this === undefined ? globalThis$U : this;
	      if ($this === ObjectPrototype$4) call$C(setter, ObjectPrototypeSymbols, value);
	      if (hasOwn$p($this, HIDDEN) && hasOwn$p($this[HIDDEN], tag)) $this[HIDDEN][tag] = false;
	    ...
	    if (DESCRIPTORS$w && USE_SETTER) setSymbolDescriptor(ObjectPrototype$4, tag, { configurable: true, set: setter });
	  ...
	  if (DESCRIPTORS$w) {
	    ...
	    {
	      defineBuiltIn$i(ObjectPrototype$4, 'propertyIsEnumerable', $propertyIsEnumerable$1, { unsafe: true });
	    }
	  }
	}

	$$1S({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
	  Symbol: $Symbol
	});
	...
	$$1S({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  useSetter: function () { USE_SETTER = true; },
	  useSimple: function () { USE_SETTER = false; }
	});

	$$1S({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$w }, {
	  // `Object.create` method
	  // https://tc39.es/ecma262/#sec-object.create
	  create: $create,
	  // `Object.defineProperty` method
	...
	$$1S({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  // `Object.getOwnPropertyNames` method
	  // https://tc39.es/ecma262/#sec-object.getownpropertynames
	...
	$$1R({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
	  'for': function (key) {
	...
	$$1Q({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
	...
	var functionApply$1 = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$B.bind(apply$a) : function () {
	  return call$B.apply(apply$a, arguments);
	});
	...
	var isRawJson = function isRawJSON(O) {
	  ...
	  var state = getInternalState$8(O);
	...
	var at$3 = uncurryThis$U(''.charAt);
	var slice$5 = uncurryThis$U(''.slice);
	...
	var parseJsonString = function (source, i) {
	  ...
	  while (i < source.length) {
	    ...
	    if (chr === '\\') {
	      ...
	      if (hasOwn$m(codePoints, twoChars)) {
	        value += codePoints[twoChars];
	        i += 2;
	      } else if (twoChars === '\\u') {
	        i += 2;
	        var fourHexDigits = slice$5(source, i, i + 4);
	        if (!exec$8(IS_4_HEX_DIGITS, fourHexDigits)) throw new $SyntaxError$1('Bad Unicode escape at: ' + i);
	      ...
	      if (exec$8(IS_C0_CONTROL_CODE, chr)) throw new $SyntaxError$1('Bad control character in string literal at: ' + i);
	      value += chr;
	      i++;
	    }
	  }
	...
	var nativeRawJson = !fails$10(function () {
	...
	var NATIVE_RAW_JSON$2 = nativeRawJson;
	...
	var numberToString$2 = uncurryThis$T(1.1.toString);
	...
	var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$3 || fails$$(function () {
	...
	var stringifyWithProperSymbolsConversion = WRONG_SYMBOLS_CONVERSION ? function (it, replacer) {
	  ...
	  args[1] = function (key, value) {
	    ...
	    if (isCallable$j($replacer)) value = call$A($replacer, this, $String$2(key), value);
	...
	var getReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$g(element) === 'Number' || classof$g(element) === 'String') push$d(keys, toString$p(element));
	  }
	...
	if ($stringify) $$1P({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE || !NATIVE_RAW_JSON$2 }, {
	  stringify: function stringify(text, replacer, space) {
	    ...
	    var json = stringifyWithProperSymbolsConversion(text, function (key, value) {
	      // some old implementations (like WebKit) could pass numbers as keys
	      var v = isCallable$j(replacerFunction) ? call$A(replacerFunction, this, $String$2(key), value) : value;
	      return !NATIVE_RAW_JSON$2 && isRawJSON$1(v) ? MARK + (push$d(rawStrings, v.rawJSON) - 1) : v;
	    }, space);

	    if (typeof json != 'string') return json;

	    if (ILL_FORMED_UNICODE) json = replace$9(json, surrogates, fixIllFormedJSON);

	    if (NATIVE_RAW_JSON$2) return json;
	...
	var FORCED$p = !NATIVE_SYMBOL$2 || fails$_(function () { getOwnPropertySymbolsModule$1.f(1); });

	// `Object.getOwnPropertySymbols` method
	// https://tc39.es/ecma262/#sec-object.getownpropertysymbols
	$$1O({ target: 'Object', stat: true, forced: FORCED$p }, {
	...
	if (DESCRIPTORS$v && isCallable$i(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  // Safari 12 bug
	  ...
	  defineBuiltInAccessor$f(SymbolPrototype, 'description', {
	    ...
	    get: function description() {
	      ...
	      if (hasOwn$l(EmptyStringDescriptionStore, symbol)) return '';
	  ...
	  $$1N({ global: true, constructor: true, forced: true }, {
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$R(aCallable$l(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var isPossiblePrototype$1 = function (argument) {
	  return isObject$v(argument) || argument === null;
	};
	...
	var aPossiblePrototype$1 = function (argument) {
	  ...
	  throw new $TypeError$p("Can't set " + $String$1(argument) + ' as a prototype');
	};
	...
	var inheritIfRequired$7 = function ($this, dummy, Wrapper) {
	  ...
	  if (
	    ...
	    NewTarget !== Wrapper &&
	    isObject$t(NewTargetPrototype = NewTarget.prototype) &&
	...
	var installErrorCause$1 = function (O, options) {
	  if (isObject$s(options) && 'cause' in options) {
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1M({ global: true, constructor: true, arity: 1, forced: FORCED$o }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1M({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$o }, O);
	  }
	};
	...
	var NativeSuppressedError = globalThis$R.SuppressedError;
	...
	var EXTRA_ARGS_SUPPORT = !!NativeSuppressedError && fails$X(function () {
	  return new NativeSuppressedError(1, 2, 3, { cause: 4 }).cause === 4;
	});

	var PATCH$1 = WRONG_ARITY$1 || EXTRA_ARGS_SUPPORT;

	var $SuppressedError = function SuppressedError(error, suppressed, message) {
	  var isInstance = isPrototypeOf$7(SuppressedErrorPrototype, this);
	  var that;
	  if (setPrototypeOf$5) {
	    that = PATCH$1 && (!isInstance || getPrototypeOf$6(this) === SuppressedErrorPrototype)
	      ? new NativeSuppressedError()
	      : setPrototypeOf$5(new $Error(), isInstance ? getPrototypeOf$6(this) : SuppressedErrorPrototype);
	  } else {
	    that = isInstance ? this : create$b(SuppressedErrorPrototype);
	    createNonEnumerableProperty$9(that, TO_STRING_TAG$3, 'Error');
	  }
	  if (message !== undefined) createNonEnumerableProperty$9(that, 'message', normalizeStringArgument$3(message));
	  installErrorStack(that, $SuppressedError, that.stack, 1);
	  createNonEnumerableProperty$9(that, 'error', error);
	  createNonEnumerableProperty$9(that, 'suppressed', suppressed);
	  return that;
	};

	if (setPrototypeOf$5) setPrototypeOf$5($SuppressedError, $Error);
	else copyConstructorProperties$2($SuppressedError, $Error, { name: true });

	var SuppressedErrorPrototype = $SuppressedError.prototype = PATCH$1 ? NativeSuppressedError.prototype : create$b($Error.prototype, {
	  constructor: createPropertyDescriptor$6(1, $SuppressedError),
	  message: createPropertyDescriptor$6(1, ''),
	  name: createPropertyDescriptor$6(1, 'SuppressedError')
	});
	...
	$$1L({ global: true, constructor: true, arity: 3, forced: PATCH$1 }, {
	...
	var createProperty$9 = function (object, key, value) {
	  if (DESCRIPTORS$t) definePropertyModule$1.f(object, key, createPropertyDescriptor$5(0, value));
	...
	var isConcatSpreadable = function (O) {
	  if (!isObject$r(O)) return false;
	  var spreadable = O[IS_CONCAT_SPREADABLE];
	  return spreadable !== undefined ? !!spreadable : isArray$6(O);
	};

	var FORCED$n = !IS_CONCAT_SPREADABLE_SUPPORT || !arrayMethodHasSpeciesSupport$4('concat');

	// `Array.prototype.concat` method
	// https://tc39.es/ecma262/#sec-array.prototype.concat
	// with adding support of @@isConcatSpreadable and @@species
	$$1J({ target: 'Array', proto: true, arity: 1, forced: FORCED$n }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$1H({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 }, {
	...
	// `Array.prototype.find` method
	// https://tc39.es/ecma262/#sec-array.prototype.find
	$$1G({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
	...
	// `Array.prototype.findIndex` method
	// https://tc39.es/ecma262/#sec-array.prototype.findindex
	$$1F({ target: 'Array', proto: true, forced: SKIPS_HOLES }, {
	  ...
	  while (sourceIndex < sourceLen) {
	    if (sourceIndex in source) {
	      ...
	      if (depth > 0 && isArray$5(element)) {
	        elementLen = lengthOfArrayLike$l(element);
	...
	$$1E({ target: 'Array', proto: true }, {
	  flat: function flat(/* depthArg = 1 */) {
	    ...
	    var sourceLen = lengthOfArrayLike$k(O);
	    var A = arraySpeciesCreate$1(O, 0);
	    A.length = flattenIntoArray(A, O, O, sourceLen, 0, depthArg === undefined ? 1 : toIntegerOrInfinity$d(depthArg));
	    return A;
	  }
	});
	...
	var callWithSafeIterationClosing$3 = function (iterator, fn, value, ENTRIES) {
	  try {
	    ...
	    iteratorClose$c(iterator, 'throw', error);
	  }
	};
	...
	var getIteratorMethod$5 = function (it) {
	  if (!isNullOrUndefined$4(it)) return getMethod$5(it, ITERATOR$8)
	...
	var FORCED$m = NEGATIVE_ZERO$1 || !arrayMethodIsStrict$5('indexOf');

	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$1B({ target: 'Array', proto: true, forced: FORCED$m }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$q(IteratorPrototype$4) || fails$S(function () {
	  var test = {};
	...
	if (!isCallable$f(IteratorPrototype$4[ITERATOR$6])) {
	  defineBuiltIn$h(IteratorPrototype$4, ITERATOR$6, function () {
	    return this;
	  });
	}
	...
	var iteratorCreateConstructor = function (IteratorConstructor, NAME, next, ENUMERABLE_NEXT) {
	  ...
	  IteratorConstructor.prototype = create$9(IteratorPrototype$3, { next: createPropertyDescriptor$4(+!ENUMERABLE_NEXT, next) });
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	    ...
	    if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
	      if (getPrototypeOf$4(CurrentIteratorPrototype) !== IteratorPrototype$2) {
	        if (setPrototypeOf$4) {
	          ...
	          defineBuiltIn$g(CurrentIteratorPrototype, ITERATOR$5, returnThis);
	        }
	      }
	  ...
	  if (IterablePrototype[ITERATOR$5] !== defaultIterator) {
	    defineBuiltIn$g(IterablePrototype, ITERATOR$5, defaultIterator, { name: DEFAULT });
	  }
	...
	var FORCED$l = NEGATIVE_ZERO || !STRICT_METHOD$2;

	// `Array.prototype.lastIndexOf` method implementation
	// https://tc39.es/ecma262/#sec-array.prototype.lastindexof
	var arrayLastIndexOf = FORCED$l ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
	  // convert -0 to +0
	  ...
	  var index = length - 1;
	  if (arguments.length > 1) index = min$8(index, toIntegerOrInfinity$c(arguments[1]));
	...
	$$1z({ target: 'Array', proto: true, forced: lastIndexOf !== [].lastIndexOf }, {
	...
	// https://tc39.es/ecma262/#sec-array.prototype.map
	// with adding support of @@species
	$$1y({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 }, {
	...
	var SILENT_ON_NON_WRITABLE_LENGTH_SET = DESCRIPTORS$r && !function () {
	...
	var FORCED$k = INCORRECT_TO_LENGTH || !properErrorOnNonWritableLength$1();

	// `Array.prototype.push` method
	// https://tc39.es/ecma262/#sec-array.prototype.push
	$$1x({ target: 'Array', proto: true, arity: 1, forced: FORCED$k }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var environment = (function () {
	  ...
	  if (classof$e(globalThis$Q.process) === 'process') return 'NODE';
	...
	var FORCED$j = CHROME_BUG$1 || !arrayMethodIsStrict$3('reduce');

	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	$$1w({ target: 'Array', proto: true, forced: FORCED$j }, {
	...
	var FORCED$i = CHROME_BUG || !arrayMethodIsStrict$2('reduceRight');
	...
	var nativeReverse = uncurryThis$O([].reverse);
	var test$1 = [1, 2];
	...
	$$1u({ target: 'Array', proto: true, forced: String(test$1) === String(test$1.reverse()) }, {
	...
	$$1t({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
	...
	var push$c = uncurryThis$N(test.push);
	...
	var FORCED$h = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$1 || !STABLE_SORT$1;
	...
	$$1s({ target: 'Array', proto: true, forced: FORCED$h }, {
	...
	// with adding support of @@species
	$$1r({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	...
	var FORCED$g = INCORRECT_RESULT || !properErrorOnNonWritableLength();

	// `Array.prototype.unshift` method
	// https://tc39.es/ecma262/#sec-array.prototype.unshift
	$$1q({ target: 'Array', proto: true, arity: 1, forced: FORCED$g }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var getInternalArrayBufferState = InternalStateModule$a.getterFor(ARRAY_BUFFER);
	...
	var $DataView = globalThis$P[DATA_VIEW];
	var DataViewPrototype$2 = $DataView && $DataView[PROTOTYPE];
	var ObjectPrototype$2 = Object.prototype;
	var Array$1 = globalThis$P.Array;
	var RangeError$3 = globalThis$P.RangeError;
	...
	if (!NATIVE_ARRAY_BUFFER$2) {
	  ...
	  if (!fails$P(function () {
	    ...
	    $ArrayBuffer$1 = function ArrayBuffer(length) {
	      anInstance$a(this, ArrayBufferPrototype$3);
	      return inheritIfRequired$5(new NativeArrayBuffer(toIndex$2(length)), this, $ArrayBuffer$1);
	    };
	...
	setToStringTag$9($ArrayBuffer$1, ARRAY_BUFFER);
	...
	$$1p({ target: 'ArrayBuffer', proto: true, unsafe: true, forced: INCORRECT_SLICE }, {
	  slice: function slice(start, end) {
	    if (nativeArrayBufferSlice && end === undefined) {
	      return nativeArrayBufferSlice(anObject$v(this), start); // FF fix
	    }
	    var length = anObject$v(this).byteLength;
	    var first = toAbsoluteIndex$2(start, length);
	    var fin = toAbsoluteIndex$2(end === undefined ? length : end, length);
	    var result = new ArrayBuffer$5(toLength$7(fin - first));
	...
	var ArrayBuffer$4 = globalThis$O.ArrayBuffer;
	...
	var arrayBufferByteLength$2 = ArrayBuffer$4 && uncurryThisAccessor$2(ArrayBuffer$4.prototype, 'byteLength', 'get') || function (O) {
	  if (classof$d(O) !== 'ArrayBuffer') throw new TypeError$7('ArrayBuffer expected');
	  return O.byteLength;
	};
	...
	var DataView$3 = globalThis$N.DataView;
	...
	var DataView$2 = globalThis$J.DataView;
	var min$6 = Math.min;
	var ArrayBufferPrototype$1 = ArrayBuffer$3.prototype;
	var DataViewPrototype = DataView$2.prototype;
	var slice$3 = uncurryThis$K(ArrayBufferPrototype$1.slice);
	...
	var getInt8 = uncurryThis$K(DataViewPrototype.getInt8);
	...
	if ($transfer$1) $$1o({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$1n({ target: 'ArrayBuffer', proto: true }, {
	...
	var dateToPrimitive$1 = function (hint) {
	  ...
	  else if (hint !== 'number') throw new $TypeError$h('Incorrect hint');
	...
	// https://tc39.es/ecma262/#sec-date.prototype-@@toprimitive
	if (!hasOwn$i(DatePrototype, TO_PRIMITIVE)) {
	  defineBuiltIn$e(DatePrototype, TO_PRIMITIVE, dateToPrimitive);
	}
	...
	$$1m({ global: true, forced: globalThis$I.globalThis !== globalThis$I }, {
	...
	var NativeIterator = globalThis$H[ITERATOR$4];

	// FF56- have non-standard global helper `Iterator`
	var FORCED$f = !isCallable$d(NativeIterator)
	  || NativeIterator.prototype !== IteratorPrototype$1
	  // FF44- non-standard `Iterator` passes previous tests
	  || !fails$M(function () { NativeIterator({}); });

	var IteratorConstructor = function Iterator() {
	  anInstance$9(this, IteratorPrototype$1);
	  if (getPrototypeOf$2(this) === IteratorPrototype$1) throw new $TypeError$g('Abstract class Iterator not directly constructable');
	};
	  ...
	  if (DESCRIPTORS$o) {
	    defineBuiltInAccessor$c(IteratorPrototype$1, key, {
	      ...
	      set: function (replacement) {
	        anObject$t(this);
	        if (this === IteratorPrototype$1) throw new $TypeError$g("You can't redefine this property");
	        if (hasOwn$h(this, key)) this[key] = replacement;
	...
	if (!hasOwn$h(IteratorPrototype$1, TO_STRING_TAG$2)) defineIteratorPrototypeAccessor(TO_STRING_TAG$2, ITERATOR$4);

	if (FORCED$f || !hasOwn$h(IteratorPrototype$1, CONSTRUCTOR) || IteratorPrototype$1[CONSTRUCTOR] === Object) {
	...
	$$1l({ global: true, constructor: true, forced: FORCED$f }, {
	...
	$$1k({ target: 'Iterator', proto: true, real: true, forced: everyWithoutClosingOnEarlyError }, {
	  every: function every(predicate) {
	    ...
	    if (everyWithoutClosingOnEarlyError) return call$u(everyWithoutClosingOnEarlyError, this, predicate);
	...
	var createIteratorProxyPrototype = function (IS_ITERATOR) {
	  ...
	  return defineBuiltIns$4(create$8(IteratorPrototype), {
	    next: function next() {
	    ...
	    'return': function () {
	      ...
	      if (IS_ITERATOR) {
	        ...
	        return returnMethod ? call$t(returnMethod, iterator) : createIterResultObject$3(undefined, true);
	      }
	      if (state.inner) try {
	...
	var FORCED$e = FILTER_WITHOUT_THROWING_ON_INVALID_ITERATOR || filterWithoutClosingOnEarlyError;
	...
	var IteratorProxy$1 = createIteratorProxy$1(function () {
	  ...
	  while (true) {
	    result = anObject$q(call$s(next, iterator));
	...
	$$1j({ target: 'Iterator', proto: true, real: true, forced: FORCED$e }, {
	  filter: function filter(predicate) {
	    ...
	    if (filterWithoutClosingOnEarlyError) return call$s(filterWithoutClosingOnEarlyError, this, predicate);
	...
	$$1i({ target: 'Iterator', proto: true, real: true, forced: findWithoutClosingOnEarlyError }, {
	  find: function find(predicate) {
	    ...
	    if (findWithoutClosingOnEarlyError) return call$r(findWithoutClosingOnEarlyError, this, predicate);
	...
	$$1h({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	  forEach: function forEach(fn) {
	    ...
	    if (forEachWithoutClosingOnEarlyError) return call$q(forEachWithoutClosingOnEarlyError, this, fn);
	...
	var FORCED$d = MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR || mapWithoutClosingOnEarlyError;

	var IteratorProxy = createIteratorProxy(function () {
	  var iterator = this.iterator;
	  var result = anObject$n(call$p(this.next, iterator));
	...
	$$1g({ target: 'Iterator', proto: true, real: true, forced: FORCED$d }, {
	  map: function map(mapper) {
	    ...
	    if (mapWithoutClosingOnEarlyError) return call$p(mapWithoutClosingOnEarlyError, this, mapper);
	...
	var FAILS_ON_INITIAL_UNDEFINED = fails$L(function () {
	  // eslint-disable-next-line es/no-iterator-prototype-reduce, es/no-array-prototype-keys, array-callback-return -- required for testing
	  [].keys().reduce(function () { /* empty */ }, undefined);
	});

	var reduceWithoutClosingOnEarlyError = !FAILS_ON_INITIAL_UNDEFINED && iteratorHelperWithoutClosingOnEarlyError$1('reduce', $TypeError$e);

	// `Iterator.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-iterator.prototype.reduce
	$$1f({ target: 'Iterator', proto: true, real: true, forced: FAILS_ON_INITIAL_UNDEFINED || reduceWithoutClosingOnEarlyError }, {
	  reduce: function reduce(reducer /* , initialValue */) {
	    ...
	    if (reduceWithoutClosingOnEarlyError) {
	      return apply$6(reduceWithoutClosingOnEarlyError, this, noInitial ? [reducer] : [reducer, accumulator]);
	    }
	...
	$$1e({ target: 'Iterator', proto: true, real: true, forced: someWithoutClosingOnEarlyError }, {
	  some: function some(predicate) {
	    ...
	    if (someWithoutClosingOnEarlyError) return call$o(someWithoutClosingOnEarlyError, this, predicate);
	...
	$$1d({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate$9(getIteratorDirect$1(anObject$k(this)), push$b, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	setToStringTag$8(globalThis$F.JSON, 'JSON', true);
	...
	var FAILS_ON_PRIMITIVES$6 = fails$J(function () { $isExtensible$1(1); });

	// `Object.isExtensible` method
	// https://tc39.es/ecma262/#sec-object.isextensible
	var objectIsExtensible = (FAILS_ON_PRIMITIVES$6 || ARRAY_BUFFER_NON_EXTENSIBLE$1) ? function isExtensible(it) {
	  if (!isObject$o(it)) return false;
	  if (ARRAY_BUFFER_NON_EXTENSIBLE$1 && classof$c(it) === 'ArrayBuffer') return false;
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var fixMethod = function (KEY) {
	    ...
	    defineBuiltIn$d(NativePrototype, KEY,
	      KEY === 'add' ? function add(value) {
	        ...
	        return IS_WEAK && !isObject$m(key) ? false : uncurriedNativeMethod(this, key === 0 ? 0 : key);
	      } : KEY === 'get' ? function get(key) {
	        return IS_WEAK && !isObject$m(key) ? undefined : uncurriedNativeMethod(this, key === 0 ? 0 : key);
	  ...
	  $$1b({ global: true, constructor: true, forced: Constructor !== NativeConstructor }, exported);
	...
	$$1a({ target: 'Math', stat: true }, {
	  clz32: function clz32(x) {
	    var n = x >>> 0;
	    return n ? 31 - floor$5(log(n + 0.5) * LOG2E) : 32;
	  }
	});
	...
	var mathExpm1 = (!$expm1
	  ...
	  var n = +x;
	  return n === 0 ? n : n > -1e-6 && n < 1e-6 ? n + n * n / 2 : exp$1(n) - 1;
	} : $expm1;
	...
	var FORCED$c = !$cosh || $cosh(710) === Infinity;

	// `Math.cosh` method
	// https://tc39.es/ecma262/#sec-math.cosh
	$$19({ target: 'Math', stat: true, forced: FORCED$c }, {
	  cosh: function cosh(x) {
	    var t = expm1$1(abs$2(x) - 1) + 1;
	...
	$$18({ target: 'Math', stat: true, forced: FORCED$b }, {
	  sinh: function sinh(x) {
	    var n = +x;
	    return abs$1(n) < 1 ? (expm1(n) - expm1(-n)) / 2 : (exp(n - 1) - exp(-n - 1)) * (E / 2);
	  }
	});
	...
	var thisNumberValue$1 = uncurryThis$H(1.1.valueOf);
	...
	var calledWithNew = function (dummy) {
	  ...
	  return isPrototypeOf$4(NumberPrototype, dummy) && fails$F(function () { thisNumberValue(dummy); });
	};
	...
	if (FORCED$a && !IS_PURE$1) NumberPrototype.constructor = NumberWrapper;

	$$16({ global: true, constructor: true, wrap: true, forced: FORCED$a }, {
	...
	if (FORCED$a || IS_PURE$1) copyConstructorProperties(path$1[NUMBER], NativeNumber);
	...
	var objectAssign = !$assign || fails$E(function () {
	  ...
	  if (DESCRIPTORS$k && $assign({ b: 1 }, $assign(defineProperty$3({}, 'a', {
	    enumerable: true,
	    get: function () {
	...
	$$15({ target: 'Object', stat: true, arity: 2, forced: Object.assign !== assign$1 }, {
	  assign: assign$1
	});
	...
	var IE_BUG = DESCRIPTORS$j && fails$D(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	var FAILS_ON_PRIMITIVES$5 = fails$C(function () { $freeze(1); });

	// `Object.freeze` method
	// https://tc39.es/ecma262/#sec-object.freeze
	$$13({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$5, sham: !FREEZING$4 }, {
	  freeze: function freeze(it) {
	    return $freeze && isObject$l(it) ? $freeze(onFreeze$2(it)) : it;
	  }
	});
	...
	var FORCED$9 = !DESCRIPTORS$i || fails$B(function () { nativeGetOwnPropertyDescriptor$1(1); });

	// `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	$$11({ target: 'Object', stat: true, forced: FORCED$9, sham: !DESCRIPTORS$i }, {
	...
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
	$$10({ target: 'Object', stat: true, sham: !DESCRIPTORS$h }, {
	...
	var FAILS_ON_PRIMITIVES$3 = fails$z(function () { nativeGetPrototypeOf(1); });

	// `Object.getPrototypeOf` method
	// https://tc39.es/ecma262/#sec-object.getprototypeof
	$$_({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$3, sham: !CORRECT_PROTOTYPE_GETTER$1 }, {
	...
	// https://tc39.es/ecma262/#sec-object.isextensible
	// eslint-disable-next-line es/no-object-isextensible -- safe
	$$Y({ target: 'Object', stat: true, forced: Object.isExtensible !== $isExtensible }, {
	...
	var FORCED$8 = ARRAY_BUFFER_NON_EXTENSIBLE || fails$y(function () { $isFrozen(1); });

	// `Object.isFrozen` method
	// https://tc39.es/ecma262/#sec-object.isfrozen
	$$X({ target: 'Object', stat: true, forced: FORCED$8 }, {
	  isFrozen: function isFrozen(it) {
	    if (!isObject$k(it)) return true;
	...
	$$V({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$1, sham: !FREEZING$3 }, {
	...
	$$U({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES, sham: !FREEZING$2 }, {
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  defineBuiltIn$c(Object.prototype, 'toString', toString$k, { unsafe: true });
	}
	...
	var speciesConstructor$3 = function (O, defaultConstructor) {
	  ...
	  var S;
	  return C === undefined || isNullOrUndefined$1(S = anObject$j(C)[SPECIES$2]) ? defaultConstructor : aConstructor$2(S);
	};
	...
	if (!set || !clear) {
	  ...
	  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
	    ...
	    isCallable$b(globalThis$C.postMessage) &&
	...
	var safeGetBuiltIn$2 = function (name) {
	  if (!DESCRIPTORS$g) return globalThis$B[name];
	  var descriptor = getOwnPropertyDescriptor$4(globalThis$B, name);
	...
	if (!microtask$2) {
	  ...
	  // - setTimeout
	    ...
	    macrotask = bind$7(macrotask, globalThis$A);
	    notify$1 = function () {
	      macrotask(flush);
	    };
	  }
	...
	var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$a(globalThis$y.PromiseRejectionEvent);
	...
	var isThenable = function (it) {
	  var then;
	  return isObject$h(it) && isCallable$9(then = it.then) ? then : false;
	};
	...
	var onUnhandled = function (state) {
	  call$m(task, globalThis$x, function () {
	...
	$$R({ target: 'Promise', stat: true, forced: PROMISE_STATICS_INCORRECT_ITERATION$2 }, {
	...
	$$L({ target: 'Promise', proto: true, real: true, forced: NON_GENERIC }, {
	  'finally': function (onFinally) {
	    var C = speciesConstructor$1(this, getBuiltIn$8('Promise'));
	...
	$$K({ target: 'Reflect', stat: true, forced: OPTIONAL_ARGUMENTS_LIST }, {
	  apply: function apply(target, thisArgument, argumentsList) {
	    return functionApply(aCallable$5(target), thisArgument, anObject$h(argumentsList));
	  }
	});
	...
	$$J({ target: 'Reflect', stat: true, forced: FORCED$7, sham: FORCED$7 }, {
	  construct: function construct(Target, args /* , newTarget */) {
	    ...
	    if (Target === newTarget) {
	      ...
	      return new (apply$4(bind$5, Target, $args))();
	    }
	    // with altered newTarget, not support built-in constructors
	    var proto = newTarget.prototype;
	    var instance = create$6(isObject$e(proto) ? proto : ObjectPrototype$1);
	...
	$$I({ target: 'Reflect', stat: true }, {
	  deleteProperty: function deleteProperty(target, propertyKey) {
	    var descriptor = getOwnPropertyDescriptor$3(anObject$f(target), propertyKey);
	...
	function get(target, propertyKey /* , receiver */) {
	  ...
	  if (descriptor) return isDataDescriptor(descriptor)
	    ? descriptor.value
	    : descriptor.get === undefined ? undefined : call$i(descriptor.get, receiver);
	  if (isObject$d(prototype = getPrototypeOf$1(target))) return get(prototype, propertyKey, receiver);
	}
	...
	setToStringTag$4(globalThis$w.Reflect, 'Reflect', true);
	...
	var regexpGetFlags = regExpFlagsDetection$1.correct ? function (it) {
	  ...
	  return (!regExpFlagsDetection$1.correct && isPrototypeOf$3(RegExpPrototype$5, it) && !hasOwn$a(it, 'flags'))
	    ? call$h(regExpFlagsGetterImplementation$1, it)
	    : it.flags;
	};
	...
	var $RegExp$2 = globalThis$u.RegExp;
	...
	var $RegExp = globalThis$s.RegExp;
	...
	var NativeRegExp = globalThis$r.RegExp;
	var RegExpPrototype$4 = NativeRegExp.prototype;
	var SyntaxError$4 = globalThis$r.SyntaxError;
	...
	if (isForced('RegExp', BASE_FORCED)) {
	  ...
	  defineBuiltIn$8(globalThis$r, 'RegExp', RegExpWrapper, { constructor: true });
	}
	...
	$$E({ target: 'RegExp', proto: true, forced: /./.exec !== exec$5 }, {
	  exec: exec$5
	});
	...
	// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
	if (DESCRIPTORS$d && !regExpFlagsDetection.correct) {
	...
	SetRecord.prototype = {
	  getIterator: function () {
	    return getIteratorDirect(anObject$9(call$d(this.keys, this.set)));
	  },
	...
	var FORCED$6 = SET_LIKE_INCORRECT_BEHAVIOR || fails$k(function () {
	...
	// `Set.prototype.difference` method
	// https://tc39.es/ecma262/#sec-set.prototype.difference
	$$C({ target: 'Set', proto: true, real: true, forced: FORCED$6 }, {
	...
	// `Set.prototype.intersection` method
	// https://tc39.es/ecma262/#sec-set.prototype.intersection
	$$B({ target: 'Set', proto: true, real: true, forced: INCORRECT$3 }, {
	...
	// `Set.prototype.isDisjointFrom` method
	// https://tc39.es/ecma262/#sec-set.prototype.isdisjointfrom
	$$A({ target: 'Set', proto: true, real: true, forced: INCORRECT$2 }, {
	...
	// `Set.prototype.isSubsetOf` method
	// https://tc39.es/ecma262/#sec-set.prototype.issubsetof
	$$z({ target: 'Set', proto: true, real: true, forced: INCORRECT$1 }, {
	...
	// `Set.prototype.isSupersetOf` method
	// https://tc39.es/ecma262/#sec-set.prototype.issupersetof
	$$y({ target: 'Set', proto: true, real: true, forced: INCORRECT }, {
	...
	// `Set.prototype.symmetricDifference` method
	// https://tc39.es/ecma262/#sec-set.prototype.symmetricdifference
	$$x({ target: 'Set', proto: true, real: true, forced: FORCED$5 }, {
	...
	// `Set.prototype.union` method
	// https://tc39.es/ecma262/#sec-set.prototype.union
	$$w({ target: 'Set', proto: true, real: true, forced: FORCED$4 }, {
	  union: union
	});
	...
	$$v({ target: 'String', proto: true, forced: FORCED$3 }, {
	  at: function at(index) {
	...
	$$u({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG$1 && !CORRECT_IS_REGEXP_LOGIC$1 }, {
	  endsWith: function endsWith(searchString /* , endPosition = @length */) {
	    var that = toString$f(requireObjectCoercible$9(this));
	...
	$$t({ target: 'String', stat: true, arity: 1, forced: INCORRECT_LENGTH }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  if (classof$6(R) === 'RegExp') return call$b(regexpExec, R, S);
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      var matcher = isObject$b(regexp) ? getMethod$3(regexp, MATCH) : undefined;
	      return matcher ? call$a(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$b(O));
	    },
	    ...
	    function (string) {
	      ...
	      var flags = toString$b(getRegExpFlags$1(rx));
	...
	// `String.prototype.padEnd` method
	// https://tc39.es/ecma262/#sec-string.prototype.padend
	$$r({ target: 'String', proto: true, forced: WEBKIT_BUG$1 }, {
	...
	// `String.prototype.padStart` method
	// https://tc39.es/ecma262/#sec-string.prototype.padstart
	$$q({ target: 'String', proto: true, forced: WEBKIT_BUG }, {
	...
	$$p({ target: 'String', stat: true }, {
	  raw: function raw(template) {
	    var rawTemplate = toIndexedObject$1(toObject$5(template).raw);
	    var literalSegments = lengthOfArrayLike$a(rawTemplate);
	    if (!literalSegments) return '';
	    var argumentsLength = arguments.length;
	    var elements = [];
	    var i = 0;
	    while (true) {
	      push$8(elements, toString$8(rawTemplate[i++]));
	      if (i === literalSegments) return join$4(elements, '');
	      if (i < argumentsLength) push$8(elements, toString$8(arguments[i]));
	    }
	  }
	});
	...
	var stringIndexOf = uncurryThis$o(''.indexOf);
	...
	fixRegExpWellKnownSymbolLogic$2('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      var replacer = isObject$a(searchValue) ? getMethod$2(searchValue, REPLACE) : undefined;
	      return replacer
	    ...
	    function (string, replaceValue) {
	      ...
	      var flags = toString$7(getRegExpFlags(rx));
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var position = max(min$4(toIntegerOrInfinity$4(result.index), S.length), 0);
	        var captures = [];
	        var replacement;
	...
	fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
	  return [
	    ...
	    function search(regexp) {
	      ...
	      var searcher = isObject$9(regexp) ? getMethod$1(regexp, SEARCH) : undefined;
	      return searcher ? call$8(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$6(O));
	    },
	...
	fixRegExpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      var splitter = isObject$8(separator) ? getMethod(separator, SPLIT) : undefined;
	      return splitter
	    ...
	    function (string, limit) {
	      ...
	      while (q < S.length) {
	        ...
	        if (
	          z === null ||
	          (e = min$3(toLength$2(splitter.lastIndex + (UNSUPPORTED_Y ? q : 0)), S.length)) === p
	        ) {
	...
	// `String.prototype.trim` method
	// https://tc39.es/ecma262/#sec-string.prototype.trim
	$$m({ target: 'String', proto: true, forced: forcedStringTrimMethod$1('trim') }, {
	  trim: function trim() {
	    return $trim(this);
	  }
	});
	...
	var Int8Array$4 = globalThis$q.Int8Array;
	var Int8ArrayPrototype$1 = Int8Array$4 && Int8Array$4.prototype;
	var Uint8ClampedArray$1 = globalThis$q.Uint8ClampedArray;
	...
	var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$1 && classof$5(globalThis$q.opera) !== 'Opera';
	...
	var getTypedArrayConstructor$6 = function (it) {
	  ...
	  return (state && hasOwn$8(state, TYPED_ARRAY_CONSTRUCTOR)) ? state[TYPED_ARRAY_CONSTRUCTOR] : getTypedArrayConstructor$6(proto);
	};
	...
	var exportTypedArrayMethod$s = function (KEY, property, forced, options) {
	  ...
	  if (forced) for (var ARRAY in TypedArrayConstructorsList) {
	    var TypedArrayConstructor = globalThis$q[ARRAY];
	...
	var exportTypedArrayStaticMethod$1 = function (KEY, property, forced) {
	  ...
	  if (setPrototypeOf$1) {
	    if (forced) for (ARRAY in TypedArrayConstructorsList) {
	      TypedArrayConstructor = globalThis$q[ARRAY];
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !isCallable$3(TypedArray$1) || TypedArray$1 === Function.prototype) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (globalThis$q[NAME]) setPrototypeOf$1(globalThis$q[NAME], TypedArray$1);
	  }
	}
	...
	if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !TypedArrayPrototype$2 || TypedArrayPrototype$2 === ObjectPrototype) {
	  ...
	  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
	    if (globalThis$q[NAME]) setPrototypeOf$1(globalThis$q[NAME].prototype, TypedArrayPrototype$2);
	  }
	}
	...
	if (DESCRIPTORS$b && !hasOwn$8(TypedArrayPrototype$2, TO_STRING_TAG)) {
	  ...
	  for (NAME in TypedArrayConstructorsList) if (globalThis$q[NAME]) {
	    createNonEnumerableProperty$3(globalThis$q[NAME], TYPED_ARRAY_TAG$1, NAME);
	  }
	}
	...
	var Int8Array$3 = globalThis$p.Int8Array;
	...
	var RangeError$2 = globalThis$o.RangeError;
	...
	if (DESCRIPTORS$a) {
	  ...
	  typedArrayConstructor.exports = function (TYPE, wrapper, CLAMPED) {
	    ...
	    var GETTER = 'get' + TYPE;
	    var SETTER = 'set' + TYPE;
	    var NativeTypedArrayConstructor = globalThis$o[CONSTRUCTOR_NAME];
	    ...
	    $$j({ global: true, constructor: true, forced: FORCED, sham: !NATIVE_ARRAY_BUFFER_VIEWS }, exported);
	...
	var getTypedArrayConstructor$4 = ArrayBufferViewCore$c.getTypedArrayConstructor;
	...
	var exportTypedArrayStaticMethod = ArrayBufferViewCore$b.exportTypedArrayStaticMethod;
	...
	var RangeError$1 = globalThis$m.RangeError;
	var Int8Array$2 = globalThis$m.Int8Array;
	var Int8ArrayPrototype = Int8Array$2 && Int8Array$2.prototype;
	var $set = Int8ArrayPrototype && Int8ArrayPrototype.set;
	var aTypedArray$7 = ArrayBufferViewCore$7.aTypedArray;
	var exportTypedArrayMethod$8 = ArrayBufferViewCore$7.exportTypedArrayMethod;

	var WORKS_WITH_OBJECTS_AND_GENERIC_ON_TYPED_ARRAYS = !fails$a(function () {
	...
	var TO_OBJECT_BUG = WORKS_WITH_OBJECTS_AND_GENERIC_ON_TYPED_ARRAYS && ArrayBufferViewCore$7.NATIVE_ARRAY_BUFFER_VIEWS && fails$a(function () {
	...
	exportTypedArrayMethod$7('slice', function slice(start, end) {
	  var list = arraySlice$3(aTypedArray$6(this), start, end);
	...
	var Uint16Array = globalThis$l.Uint16Array;
	...
	var Int8Array$1 = globalThis$k.Int8Array;
	...
	var Uint8Array$4 = globalThis$j.Uint8Array;
	...
	var IS_IE11 = !globalThis$i.ActiveXObject && 'ActiveXObject' in globalThis$i;
	var InternalWeakMap;
	...
	var hasMSEdgeFreezingBug = function () {
	  return FREEZING$1 && fails$5(function () {
	...
	// https://github.com/tc39/proposal-json-parse-with-source
	$$h({ target: 'JSON', stat: true, forced: !NATIVE_RAW_JSON$1 }, {
	  isRawJSON: isRawJSON
	});
	...
	var JSON$1 = globalThis$h.JSON;
	var Number$1 = globalThis$h.Number;
	var SyntaxError$3 = globalThis$h.SyntaxError;
	...
	Context.prototype = {
	  ...
	  number: function () {
	    ...
	    else if (exec$4(IS_NON_ZERO_DIGIT, at$2(source, i))) i = this.skip(IS_DIGIT, i + 1);
	  ...
	  skip: function (regex, i) {
	    var source = this.source;
	    for (; i < source.length; i++) if (!exec$4(regex, at$2(source, i))) break;
	    return i;
	  },
	...
	var parse = getBuiltIn$4('JSON', 'parse');
	var create$2 = getBuiltIn$4('Object', 'create');
	var freeze = getBuiltIn$4('Object', 'freeze');
	...
	// https://github.com/tc39/proposal-json-parse-with-source
	$$f({ target: 'JSON', stat: true, forced: !NATIVE_RAW_JSON }, {
	  rawJSON: function rawJSON(text) {
	    ...
	    setInternalState$3(obj, { type: 'RawJSON' });
	...
	var SyntaxError$2 = globalThis$g.SyntaxError;
	...
	var Uint8Array$3 = globalThis$f.Uint8Array;
	...
	if (Uint8Array$3) $$e({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$2 }, {
	...
	var SyntaxError$1 = globalThis$e.SyntaxError;
	var parseInt$2 = globalThis$e.parseInt;
	var min = Math.min;
	var NOT_HEX = /[^\da-f]/i;
	var exec$3 = uncurryThis$8(NOT_HEX.exec);
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (globalThis$d.Uint8Array) $$d({ target: 'Uint8Array', proto: true }, {
	...
	var Uint8Array$1 = globalThis$c.Uint8Array;
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array$1) $$c({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$1 }, {
	  toBase64: function toBase64(/* options */) {
	    ...
	    var at = function (shift) {
	      return charAt$2(alphabet, (triplet >> (6 * shift)) & 63);
	    };
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array) $$b({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS }, {
	...
	$$8({ global: true, bind: true, enumerable: true, forced: globalThis$7.clearImmediate !== clearImmediate }, {
	...
	$$7({ global: true, bind: true, enumerable: true, forced: globalThis$5.setImmediate !== setImmediate }, {
	...
	$$3({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$1 }, {
	  URL: URLConstructor
	});
...
//# sourceMappingURL=polyfills-legacy-DAzKPgHj.js.map
