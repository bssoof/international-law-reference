(function () {
	...
	var toString$r = uncurryThis$15({}.toString);
	...
	var $Object$5 = Object;
	var split$3 = uncurryThis$14(''.split);
	...
	var objectIsPrototypeOf = uncurryThis$13({}.isPrototypeOf);
	...
	var getMethod$8 = function (V, P) {
	  var func = V[P];
	  return isNullOrUndefined$5(func) ? undefined : aCallable$m(func);
	};
	...
	var ordinaryToPrimitive$2 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$r(fn = input.toString) && !isObject$z(val = call$G(fn, input))) return val;
	  if (isCallable$r(fn = input.valueOf) && !isObject$z(val = call$G(fn, input))) return val;
	  if (pref !== 'string' && isCallable$r(fn = input.toString) && !isObject$z(val = call$G(fn, input))) return val;
	...
	var toString$q = uncurryThis$11(1.1.toString);
	...
	var wellKnownSymbol$y = function (name) {
	  if (!hasOwn$x(WellKnownSymbolsStore$1, name)) {
	    WellKnownSymbolsStore$1[name] = NATIVE_SYMBOL$6 && hasOwn$x(Symbol$1, name)
	      ? Symbol$1[name]
	...
	var toPrimitive$3 = function (input, pref) {
	  if (!isObject$y(input) || isSymbol$5(input)) return input;
	  var exoticToPrim = getMethod$7(input, TO_PRIMITIVE$1);
	  var result;
	  if (exoticToPrim) {
	    if (pref === undefined) pref = 'default';
	    result = call$F(exoticToPrim, input, pref);
	    if (!isObject$y(result) || isSymbol$5(result)) return result;
	...
	var ie8DomDefine = !DESCRIPTORS$E && !fails$11(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$D ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$w(O, P)) return createPropertyDescriptor$a(!call$E(propertyIsEnumerableModule$2.f, O, P), O[P]);
	};
	...
	var v8PrototypeDefineBug = DESCRIPTORS$C && fails$10(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var EXISTS = hasOwn$v(FunctionPrototype$1, 'name');
	...
	var functionToString = uncurryThis$10(Function.toString);
	...
	if (NATIVE_WEAK_MAP$1 || shared$4.state) {
	  ...
	  set$2 = function (it, metadata) {
	    if (hasOwn$u(it, STATE)) throw new TypeError$9(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
	...
	var join$7 = uncurryThis$$([].join);

	var CONFIGURABLE_LENGTH = DESCRIPTORS$y && !fails$$(function () {
	...
	var makeBuiltIn$2 = makeBuiltIn$3.exports = function (value, name, options) {
	  ...
	  if (CONFIGURABLE_LENGTH && options && hasOwn$t(options, 'arity') && value.length !== options.arity) {
	    defineProperty$c(value, 'length', { value: options.arity });
	  }
	  try {
	    if (options && hasOwn$t(options, 'constructor') && options.constructor) {
	      if (DESCRIPTORS$y) defineProperty$c(value, 'prototype', { writable: false });
	    // in V8 ~ Chrome 53, prototypes of some methods, like `Array.prototype.values`, are non-writable
	    } else if (value.prototype) value.prototype = undefined;
	  } catch (error) { /* empty */ }
	  var state = enforceInternalState$4(value);
	  if (!hasOwn$t(state, 'source')) {
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$s(hiddenKeys$4, key) && hasOwn$s(O, key) && push$g(result, key);
	...
	var ownKeys$2 = getBuiltIn$i('Reflect', 'ownKeys') || function ownKeys(it) {
	...
	*/
	...
	var wellKnownSymbolDefine = function (NAME) {
	  ...
	  if (!hasOwn$q(Symbol, NAME)) defineProperty$a(Symbol, NAME, {
	...
	var setToStringTag$e = function (target, TAG, STATIC) {
	  ...
	  if (target && !hasOwn$p(target, TO_STRING_TAG$4)) {
	...
	var bind$e = uncurryThis$W(uncurryThis$W.bind);
	...
	var exec$9 = uncurryThis$V(constructorRegExp.exec);
	...
	var setSymbolDescriptor = DESCRIPTORS$w && fails$Y(function () {
	...
	var $defineProperty = function defineProperty(O, P, Attributes) {
	  ...
	  if (hasOwn$o(AllSymbols, key)) {
	    if (!Attributes.enumerable) {
	      if (!hasOwn$o(O, HIDDEN)) nativeDefineProperty$1(O, HIDDEN, createPropertyDescriptor$8(1, nativeObjectCreate(null)));
	      O[HIDDEN][key] = true;
	    } else {
	...
	var $getOwnPropertyNames = function getOwnPropertyNames(O) {
	  ...
	  $forEach$2(names, function (key) {
	    if (!hasOwn$o(AllSymbols, key) && !hasOwn$o(hiddenKeys$1, key)) push$e(result, key);
	  });
	  return result;
	};
	...
	$$1C({ global: true, constructor: true, wrap: true, forced: !NATIVE_SYMBOL$5, sham: !NATIVE_SYMBOL$5 }, {
	  Symbol: $Symbol
	});
	...
	$$1C({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  useSetter: function () { USE_SETTER = true; },
	  useSimple: function () { USE_SETTER = false; }
	});

	$$1C({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5, sham: !DESCRIPTORS$w }, {
	  // `Object.create` method
	  // https://tc39.es/ecma262/#sec-object.create
	  create: $create,
	  // `Object.defineProperty` method
	...
	$$1C({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$5 }, {
	  // `Object.getOwnPropertyNames` method
	  // https://tc39.es/ecma262/#sec-object.getownpropertynames
	...
	$$1B({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY$1 }, {
	  'for': function (key) {
	...
	$$1A({ target: 'Symbol', stat: true, forced: !NATIVE_SYMBOL_REGISTRY }, {
	...
	var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$B.bind(apply$a) : function () {
	...
	var slice$5 = uncurryThis$S(''.slice);
	...
	var parseJsonString = function (source, i) {
	  ...
	  while (i < source.length) {
	    ...
	    if (chr === '\\') {
	      ...
	      if (hasOwn$l(codePoints, twoChars)) {
	...
	var nativeRawJson = !fails$X(function () {
	...
	var numberToString$2 = uncurryThis$R(1.1.toString);
	...
	var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$3 || fails$W(function () {
	...
	var getReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$f(element) === 'Number' || classof$f(element) === 'String') push$d(keys, toString$n(element));
	  }
	...
	if ($stringify) $$1z({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE || !NATIVE_RAW_JSON }, {
	  stringify: function stringify(text, replacer, space) {
	    ...
	    var json = stringifyWithProperSymbolsConversion(text, function (key, value) {
	      ...
	      return !NATIVE_RAW_JSON && isRawJSON(v) ? MARK + (push$d(rawStrings, v.rawJSON) - 1) : v;
	    }, space);
	...
	var FORCED$n = !NATIVE_SYMBOL$2 || fails$V(function () { getOwnPropertySymbolsModule$1.f(1); });

	// `Object.getOwnPropertySymbols` method
	// https://tc39.es/ecma262/#sec-object.getownpropertysymbols
	$$1y({ target: 'Object', stat: true, forced: FORCED$n }, {
	...
	if (DESCRIPTORS$v && isCallable$i(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  ...
	  $$1x({ global: true, constructor: true, forced: true }, {
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$P(aCallable$k(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var isPossiblePrototype$1 = function (argument) {
	  return isObject$s(argument) || argument === null;
	};
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1w({ global: true, constructor: true, arity: 1, forced: FORCED$m }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1w({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$m }, O);
	  }
	};
	...
	var EXTRA_ARGS_SUPPORT = !!NativeSuppressedError && fails$S(function () {
	...
	var $SuppressedError = function SuppressedError(error, suppressed, message) {
	  ...
	  if (setPrototypeOf$5) {
	    ...
	    that = isInstance ? this : create$a(SuppressedErrorPrototype);
	...
	var SuppressedErrorPrototype = $SuppressedError.prototype = PATCH$1 ? NativeSuppressedError.prototype : create$a($Error.prototype, {
	...
	$$1v({ global: true, constructor: true, arity: 3, forced: PATCH$1 }, {
	...
	$$1u({ target: 'Array', proto: true, arity: 1, forced: FORCED$l }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$1t({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$3 }, {
	...
	// `Array.prototype.find` method
	// https://tc39.es/ecma262/#sec-array.prototype.find
	$$1s({ target: 'Array', proto: true, forced: SKIPS_HOLES$1 }, {
	...
	// `Array.prototype.findIndex` method
	// https://tc39.es/ecma262/#sec-array.prototype.findindex
	$$1r({ target: 'Array', proto: true, forced: SKIPS_HOLES }, {
	  ...
	  while (sourceIndex < sourceLen) {
	    if (sourceIndex in source) {
	      ...
	      if (depth > 0 && isArray$5(element)) {
	        elementLen = lengthOfArrayLike$m(element);
	...
	var getIterator$4 = function (argument, usingIterator) {
	  ...
	  if (aCallable$j(iteratorMethod)) return anObject$t(call$y(iteratorMethod, argument));
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$1o({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	var FORCED$k = NEGATIVE_ZERO$1 || !arrayMethodIsStrict$5('indexOf');

	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$1n({ target: 'Array', proto: true, forced: FORCED$k }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$n(IteratorPrototype$4) || fails$N(function () {
	  var test = {};
	...
	var iteratorCreateConstructor = function (IteratorConstructor, NAME, next, ENUMERABLE_NEXT) {
	  ...
	  IteratorConstructor.prototype = create$8(IteratorPrototype$3, { next: createPropertyDescriptor$4(+!ENUMERABLE_NEXT, next) });
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$1m({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	var FORCED$j = INCORRECT_TO_LENGTH || !properErrorOnNonWritableLength$1();

	// `Array.prototype.push` method
	// https://tc39.es/ecma262/#sec-array.prototype.push
	$$1k({ target: 'Array', proto: true, arity: 1, forced: FORCED$j }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var environment = (function () {
	  ...
	  if (classof$d(globalThis$Q.process) === 'process') return 'NODE';
	...
	var FORCED$i = CHROME_BUG$1 || !arrayMethodIsStrict$4('reduce');

	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	$$1j({ target: 'Array', proto: true, forced: FORCED$i }, {
	...
	var FORCED$h = CHROME_BUG || !arrayMethodIsStrict$3('reduceRight');

	// `Array.prototype.reduceRight` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduceright
	$$1i({ target: 'Array', proto: true, forced: FORCED$h }, {
	...
	$$1h({ target: 'Array', proto: true, forced: String(test$1) === String(test$1.reverse()) }, {
	...
	$$1g({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
	...
	var push$c = uncurryThis$L(test.push);
	...
	var FORCED$g = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$2 || !STABLE_SORT$1;
	...
	$$1f({ target: 'Array', proto: true, forced: FORCED$g }, {
	...
	$$1e({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$8(max$2(toIntegerOrInfinity$b(deleteCount), 0), len - actualStart);
	    }
	...
	var FORCED$f = INCORRECT_RESULT || !properErrorOnNonWritableLength();
	...
	$$1c({ target: 'ArrayBuffer', proto: true, unsafe: true, forced: INCORRECT_SLICE }, {
	  slice: function slice(start, end) {
	    if (nativeArrayBufferSlice && end === undefined) {
	      return nativeArrayBufferSlice(anObject$s(this), start); // FF fix
	    }
	    var length = anObject$s(this).byteLength;
	...
	var arrayBufferByteLength$2 = ArrayBuffer$4 && uncurryThisAccessor$2(ArrayBuffer$4.prototype, 'byteLength', 'get') || function (O) {
	  if (classof$c(O) !== 'ArrayBuffer') throw new TypeError$7('ArrayBuffer expected');
	  return O.byteLength;
	};
	...
	var slice$3 = uncurryThis$I(ArrayBufferPrototype$1.slice);
	...
	if ($transfer$1) $$1b({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$1a({ target: 'ArrayBuffer', proto: true }, {
	...
	$$19({ global: true, forced: globalThis$I.globalThis !== globalThis$I }, {
	...
	var FORCED$e = !isCallable$d(NativeIterator)
	...
	if (!hasOwn$g(IteratorPrototype$1, TO_STRING_TAG$2)) defineIteratorPrototypeAccessor(TO_STRING_TAG$2, ITERATOR$4);

	if (FORCED$e || !hasOwn$g(IteratorPrototype$1, CONSTRUCTOR) || IteratorPrototype$1[CONSTRUCTOR] === Object) {
	...
	$$18({ global: true, constructor: true, forced: FORCED$e }, {
	...
	var FORCED$d = FILTER_WITHOUT_THROWING_ON_INVALID_ITERATOR || filterWithoutClosingOnEarlyError;
	...
	var IteratorProxy$1 = createIteratorProxy$1(function () {
	  ...
	  while (true) {
	    result = anObject$n(call$s(next, iterator));
	...
	$$16({ target: 'Iterator', proto: true, real: true, forced: FORCED$d }, {
	...
	$$14({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	...
	var FORCED$c = MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR || mapWithoutClosingOnEarlyError;

	var IteratorProxy = createIteratorProxy(function () {
	  var iterator = this.iterator;
	  var result = anObject$k(call$p(this.next, iterator));
	...
	$$13({ target: 'Iterator', proto: true, real: true, forced: FORCED$c }, {
	...
	var FAILS_ON_INITIAL_UNDEFINED = fails$G(function () {
	...
	$$12({ target: 'Iterator', proto: true, real: true, forced: FAILS_ON_INITIAL_UNDEFINED || reduceWithoutClosingOnEarlyError }, {
	...
	$$11({ target: 'Iterator', proto: true, real: true, forced: someWithoutClosingOnEarlyError }, {
	...
	$$10({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate$9(getIteratorDirect$1(anObject$h(this)), push$b, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	var FAILS_ON_PRIMITIVES$4 = fails$E(function () { $isExtensible(1); });
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var fixMethod = function (KEY) {
	    ...
	    defineBuiltIn$d(NativePrototype, KEY,
	      KEY === 'add' ? function add(value) {
	        ...
	        return IS_WEAK && !isObject$j(key) ? false : uncurriedNativeMethod(this, key === 0 ? 0 : key);
	      } : KEY === 'get' ? function get(key) {
	        return IS_WEAK && !isObject$j(key) ? undefined : uncurriedNativeMethod(this, key === 0 ? 0 : key);
	  ...
	  var REPLACE = isForced$3(
	    CONSTRUCTOR_NAME,
	    !isCallable$c(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$C(function () {
	  ...
	  $$_({ global: true, constructor: true, forced: Constructor !== NativeConstructor }, exported);
	...
	var FORCED$b = !$cosh || $cosh(710) === Infinity;

	// `Math.cosh` method
	// https://tc39.es/ecma262/#sec-math.cosh
	$$Y({ target: 'Math', stat: true, forced: FORCED$b }, {
	...
	$$X({ target: 'Math', stat: true, forced: FORCED$a }, {
	...
	var thisNumberValue$1 = uncurryThis$F(1.1.valueOf);
	...
	var createMethod$4 = function (TYPE) {
	  return function ($this) {
	    var string = toString$j(requireObjectCoercible$a($this));
	...
	var FORCED$9 = isForced$2(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'));
	...
	$$W({ global: true, constructor: true, wrap: true, forced: FORCED$9 }, {
	...
	var copyConstructorProperties = function (target, source) {
	  for (var keys = DESCRIPTORS$l ? getOwnPropertyNames$3(source) : (
	    ...
	    if (hasOwn$e(source, key = keys[j]) && !hasOwn$e(target, key)) {
	      defineProperty$4(target, key, getOwnPropertyDescriptor$4(source, key));
	    }
	  }
	};
	if (FORCED$9 || IS_PURE$1) copyConstructorProperties(path$1[NUMBER], NativeNumber);
	...
	var IE_BUG = DESCRIPTORS$j && fails$y(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	var FAILS_ON_PRIMITIVES$3 = fails$x(function () { $freeze(1); });

	// `Object.freeze` method
	// https://tc39.es/ecma262/#sec-object.freeze
	$$T({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES$3, sham: !FREEZING$1 }, {
	...
	var FORCED$8 = !DESCRIPTORS$i || fails$w(function () { nativeGetOwnPropertyDescriptor$1(1); });

	// `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	$$R({ target: 'Object', stat: true, forced: FORCED$8, sham: !DESCRIPTORS$i }, {
	...
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptors
	$$Q({ target: 'Object', stat: true, sham: !DESCRIPTORS$h }, {
	...
	var FAILS_ON_PRIMITIVES$1 = fails$u(function () { nativeGetPrototypeOf(1); });
	...
	var FAILS_ON_PRIMITIVES = fails$t(function () { nativeKeys(1); });

	// `Object.keys` method
	// https://tc39.es/ecma262/#sec-object.keys
	$$N({ target: 'Object', stat: true, forced: FAILS_ON_PRIMITIVES }, {
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  defineBuiltIn$c(Object.prototype, 'toString', toString$i, { unsafe: true });
	}
	...
	var speciesConstructor$3 = function (O, defaultConstructor) {
	  ...
	  var S;
	  return C === undefined || isNullOrUndefined$1(S = anObject$g(C)[SPECIES$2]) ? defaultConstructor : aConstructor$2(S);
	};
	...
	var safeGetBuiltIn$2 = function (name) {
	  ...
	  var descriptor = getOwnPropertyDescriptor$3(globalThis$B, name);
	...
	$$E({ target: 'Promise', proto: true, real: true, forced: NON_GENERIC }, {
	  'finally': function (onFinally) {
	    var C = speciesConstructor$1(this, getBuiltIn$7('Promise'));
	...
	$$D({ target: 'Reflect', stat: true, forced: FORCED$7, sham: FORCED$7 }, {
	  construct: function construct(Target, args /* , newTarget */) {
	    ...
	    var instance = create$5(isObject$e(proto) ? proto : ObjectPrototype$1);
	...
	function get(target, propertyKey /* , receiver */) {
	  ...
	  if (anObject$d(target) === receiver) return target[propertyKey];
	...
	var exec$6 = uncurryThis$z(RegExpPrototype$4.exec);
	...
	var replace$4 = uncurryThis$y(''.replace);
	...
	$$A({ target: 'RegExp', proto: true, forced: /./.exec !== exec$5 }, {
	  exec: exec$5
	});
	...
	var NOT_GENERIC = fails$k(function () { return nativeToString.call({ source: 'a', flags: 'b' }) !== '/a/b'; });
	...
	var FORCED$6 = SET_LIKE_INCORRECT_BEHAVIOR || fails$j(function () {
	...
	// `Set.prototype.difference` method
	// https://tc39.es/ecma262/#sec-set.prototype.difference
	$$y({ target: 'Set', proto: true, real: true, forced: FORCED$6 }, {
	...
	// `Set.prototype.intersection` method
	// https://tc39.es/ecma262/#sec-set.prototype.intersection
	$$x({ target: 'Set', proto: true, real: true, forced: INCORRECT$3 }, {
	...
	// `Set.prototype.isDisjointFrom` method
	// https://tc39.es/ecma262/#sec-set.prototype.isdisjointfrom
	$$w({ target: 'Set', proto: true, real: true, forced: INCORRECT$2 }, {
	...
	// `Set.prototype.isSubsetOf` method
	// https://tc39.es/ecma262/#sec-set.prototype.issubsetof
	$$v({ target: 'Set', proto: true, real: true, forced: INCORRECT$1 }, {
	...
	// `Set.prototype.symmetricDifference` method
	// https://tc39.es/ecma262/#sec-set.prototype.symmetricdifference
	$$t({ target: 'Set', proto: true, real: true, forced: FORCED$5 }, {
	...
	// `Set.prototype.union` method
	// https://tc39.es/ecma262/#sec-set.prototype.union
	$$s({ target: 'Set', proto: true, real: true, forced: FORCED$4 }, {
	  union: union
	});
	...
	$$r({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG$1 && !CORRECT_IS_REGEXP_LOGIC$1 }, {
	  endsWith: function endsWith(searchString /* , endPosition = @length */) {
	    var that = toString$e(requireObjectCoercible$9(this));
	    notARegExp$2(searchString);
	    var endPosition = arguments.length > 1 ? arguments[1] : undefined;
	    var len = that.length;
	    var end = endPosition === undefined ? len : min$6(toLength$6(endPosition), len);
	...
	$$q({ target: 'String', stat: true, arity: 1, forced: INCORRECT_LENGTH }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      return matcher ? call$a(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$a(O));
	    },
	    ...
	    function (string) {
	      ...
	      var flags = toString$a(getRegExpFlags$1(rx));
	...
	var repeat$1 = uncurryThis$q($repeat);
	...
	// `String.prototype.padEnd` method
	// https://tc39.es/ecma262/#sec-string.prototype.padend
	$$o({ target: 'String', proto: true, forced: WEBKIT_BUG$1 }, {
	...
	// `String.prototype.padStart` method
	// https://tc39.es/ecma262/#sec-string.prototype.padstart
	$$n({ target: 'String', proto: true, forced: WEBKIT_BUG }, {
	...
	$$m({ target: 'String', stat: true }, {
	  raw: function raw(template) {
	    var rawTemplate = toIndexedObject$2(toObject$5(template).raw);
	    var literalSegments = lengthOfArrayLike$b(rawTemplate);
	    if (!literalSegments) return '';
	    var argumentsLength = arguments.length;
	    var elements = [];
	    var i = 0;
	    while (true) {
	      push$8(elements, toString$7(rawTemplate[i++]));
	      if (i === literalSegments) return join$4(elements, '');
	      if (i < argumentsLength) push$8(elements, toString$7(arguments[i]));
	    }
	  }
	});
	...
	fixRegExpWellKnownSymbolLogic$2('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  return [
	    ...
	    function (string, replaceValue) {
	      ...
	      var flags = toString$6(getRegExpFlags(rx));
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var position = max(min$5(toIntegerOrInfinity$5(result.index), S.length), 0);
	        var captures = [];
	        var replacement;
	        ...
	        if (functionalReplace) {
	          ...
	          replacement = toString$6(apply$4(replaceValue, undefined, replacerArgs));
	        } else {
	...
	var nativeSet = uncurryThis$c(WeakMapPrototype.set);
	...
	if (NATIVE_WEAK_MAP) if (IS_IE11) {
	  ...
	  var nativeDelete = uncurryThis$c(WeakMapPrototype['delete']);
	  var nativeHas = uncurryThis$c(WeakMapPrototype.has);
	  var nativeGet = uncurryThis$c(WeakMapPrototype.get);
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (globalThis$d.Uint8Array) $$e({ target: 'Uint8Array', proto: true }, {
	...
	$$9({ global: true, bind: true, enumerable: true, forced: globalThis$7.clearImmediate !== clearImmediate }, {
	...
	$$8({ global: true, bind: true, enumerable: true, forced: globalThis$5.setImmediate !== setImmediate }, {
	...
	$$4({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$1 }, {
	  URL: URLConstructor
	});
...
//# sourceMappingURL=polyfills-legacy-BmovQJrc.js.map
